...
const ServicesShelf = () => 
  <section className="diagonal anticlockwise" style={styles.section}>
    <SectionHeading title="Our Expertise" smallText="" />
    <div className="container">
      <div className="row">
        <div style={styles.col} className="col-xs-6 col-sm-4"><CircleIcon iconURL={web} description="Web Deveopment" /></div>
        <div style={styles.col} className="col-xs-6 col-sm-4"><CircleIcon iconURL={print} description="SEO" /></div>
        ...
        <div style={styles.col} className="clearfix visible-xs-block"></div>
        <div style={styles.col} className="col-xs-6 col-sm-4"><CircleIcon iconURL={presentation} description="Marketing & Analysis" /></div>
        <div style={styles.col} className="col-xs-6 col-sm-4"><CircleIcon iconURL={dev} description="Business Support" /></div>
      </div>
    </div>
