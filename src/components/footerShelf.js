    ...
    return (
      <section className="diagonal clockwise" style={styles.section}>
        ...
        <div style={styles.footer}>
          <ul style={styles.ul}>
            <li style={styles.li}><a style={styles.a} href="https://twitter.com/MoizBuli"><img src={twitter} /></a></li>
            <li style={styles.li}><a style={styles.a} href="https://www.instagram.com/m0zeee/"><img src={instagram} /></a></li>
            <li style={styles.li}><a style={styles.a} href="https://in.pinterest.com/myfulk/"><img src={pinterest} /></a></li>
          </ul>
          <p style={styles.p}>Copyright 2018 &copy; Fulk Tech Developers</p>
          <p style={styles.pSmall}>Developed by <a href="https://myfulk.com">Fulk Tech Developers</a></p>
        </div>
