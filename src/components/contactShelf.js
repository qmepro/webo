  ...
  <section className="diagonal anticlockwise" style={styles.section}>
    ...
    <div className="container">
      <div className="row text-center">
        <div style={styles.col} className="col-xs-6 col-sm-4"><CircleIcon iconURL={email} circleColour="#7FB9FF" textColor="white" description="you@myfulk.com" /></div>
        <div style={styles.col} className="col-xs-6 col-sm-4"><CircleIcon iconURL={phone} circleColour="#7FB9FF" textColor="white" description="+91 7888 125 326" /></div>
        <div className="clearfix visible-xs-block"></div>
        <div style={styles.col} className="col-xs-6 col-sm-4 col-centered"><CircleIcon iconURL={social} circleColour="#7FB9FF" textColor="white" description="@m0zeee" /></div>
